<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tache_re_no.aspx.cs" Inherits="gestiontaches.etudiant.tache_re_no" %>
...
<body>
    ...
    <nav class="navbar navbar-dark">
        ...
        <asp:GridView ID="GridView1" runat="server" Width="1222px" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" Height="240px">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#GridView1 tbody').on('dblclick', 'tr', function () {
                ...
                var statuse = $(this).find('td:eq(8)').text();
                var priority = $(this).find('td:eq(9)').text();
